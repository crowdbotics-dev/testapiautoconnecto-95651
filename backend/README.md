...
## Project Structure
    ...
    ├── testapiautoconnecto_95651  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnecto_95651`
...
2. Clone this repo and `cd testapiautoconnecto_95651`
